...
public class PreferencesTest {
    ...
    void testRoundTrip() throws Exception {
        ...
        new PreferencesEncoder<CodableTest.CodingKeys>(TESTING_PREF_NODE)
            .encode(original);
        CodableTest decoded = new PreferencesDecoder<CodableTest.CodingKeys>(TESTING_PREF_NODE)
            .decode(CodableTest.class);
